<?php
  ...
  $sql="SELECT f.Customer, month(date), sum(revenue) from f_gbi f join d_customer d on f.Customer = d.Customer group by d.Customer, month(date)";
...
<html>
  <head>
    <meta charset="utf-8">
    <title>Total Monthly Customer Revenue</title>
  ...
  <body>
	...
	<a-entity id="diagram-monat" rotation ="0 90 0" position="6 1 5">
	...
	<?php
	  ...
	  while ($row = $res->fetch_row()) {
		...
		print "<a-box position=\"$x $v2 $z\" rotation=\"0 0 0\" scale=\"0.6 $val 0.6\" color=\"#81081c\" change-color-on-hover=\"color: blue\"></a-box>\n";
	  }
	?>
	</a-entity>
	...
	<!-- Diagrammtext -->
		...
		<a-entity position="-6.3 0 -6.3" rotation="0 0 90" material="color: #eee" text="color: white; align: center; value: Revenue; width: 6">
        </a-entity>
		<a-entity position="-6 - -8.5" rotation="0 -90 0" material="color: #eee" text="color: white; align: center; value: Month; width: 6">
        </a-entity>
		<a-entity position="0 7 -10" geometry="primitive: plane; width: 8; height: 1" material="color: #fff" text="color: blue; align: center; value: Total Monthly Customer Revenue; width: 10">
        </a-entity>
	...
	<!-- Diagrammline -->
		...
		line__2="start: -6 -0.5 -6.3; end: -6 10 -6.3; color:white">
		</a-entity>
    </a-entity>
